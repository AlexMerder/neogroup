...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, TimeRecord> producerFactory(
    ...
    @Bean
    public KafkaTemplate<String, TimeRecord> kafkaTemplate(
        ProducerFactory<String, TimeRecord> producerFactory) {
